...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
        <?php 
$gelendeger = $_GET["search"];


$listele = $db->query("SELECT * from post  where baslik like '%$gelendeger%'", PDO::FETCH_ASSOC);
    if($listele->rowCount()){
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3 class="text-center">
                            <a href="ornekPost.php?id=<?php echo $list['id']; ?>">
                                 <?php echo $list["baslik"]; ?>
                            </a>
                        </h3>
                        <p class="text-justify"><?php echo $list["aciklama"]; ?></p>
                        <p>
                            
                            <a href="#" data-toggle="modal" data-target="#productinfo" class="btn btn-info pull-right">
                                <span class="glyphicon glyphicon-info-sign"></span>&nbsp;Görüntüle
                            </a>
                        </p>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-4 text-justify">
                                    ...
                                    <p class="text-right mt-4 mb-4">
                                        <b>Görüntülenme sayısı: 100</b>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <a href="ornekPost.html" class="btn btn-success">Tam Görüntüle</a>
